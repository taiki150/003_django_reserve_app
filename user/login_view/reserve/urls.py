...
from .views import (
    ...
    ReserveGraphView,APIReserveGetDataView,
)
...
urlpatterns = [
    ...
    path('reserve_graph/', ReserveGraphView.as_view(), name='reserve_graph'),
    ...
    # 予約検索用のURL(非同期処理)
    path('api/reservation/getData/', APIReserveGetDataView.as_view(), name='api_reservation_get_data'),
